...
export default function Stepper() {
    return (
        <div className='flex flex-col xl:flex-row w-full h-full justify-center  gap-10 xl:gap-16 relative  '>

            <div className='flex flex-col justify-center items-center xl:items-center w-full xl:max-w-[34%] gap-8'>
                <StepCard
                    number="01"
                ...
                <div className="relative hidden  xl:flex items-center justify-center min-h-[280px]">
            ...
            <div className='hidden xl:flex flex-col items-center justify-around relative'>
            ...
            <div className='hidden xl:flex flex-col items-center xl:items-center justify-center w-full xl:max-w-[34%] gap-8'>
