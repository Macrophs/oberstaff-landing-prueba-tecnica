import { ArrowRight, Briefcase, User, UsersRound } from 'lucide-react'
...
export default function AboutUsMainCard() {
    return (
        <div className='flex justify-center w-full gap-20 '>
            ...
            {/*First Card*/}
            <div className='shadow-2xl rounded-4xl w-[35%] border-4 border-pink-dark/70 p-10 flex flex-col gap-8 transition-all duration-500 transform hover:-translate-y-2'>
                ...
                <section className='flex gap-2'>
                    ...
                    <div className='flex flex-col'>
                        <h3 className='text-2xl font-bold text-gray-dark '>Talento Profesional</h3>
                        <p className=' text-pink-dark font-bold'>100% Remoto</p>
                    </div>

                    <div className='ml-auto flex-col  text-right'>
                        <h3 className='text-2xl font-extrabold text-pink-dark '>70%</h3>
                ...
                <section className='flex justify-center w-full border-t border-gray-300/50 pt-4 mt-auto '>
                    ...
                    <p className='text-pink-light text-center font-semibold text-sm'>
                        Disponibilidad 24/7
            ...
            {/*Second Card*/}
            <div className='shadow-2xl rounded-4xl w-[35%]  p-10 flex flex-col gap-8  bg-gradient-to-br from-blue-dark via-blue-dark/90 to-purple-contrast transition-all duration-500 transform hover:-translate-y-2'>
                ...
                <section className='flex gap-2'>
                    ...
                    <div className='flex flex-col'>
                        <h3 className='text-2xl font-bold text-background '>Beneficio Mutuo</h3>
                ...
                <section className='flex justify-center w-full border-t border-gray-300/50 pt-4 mt-auto '>
                    ...
                    <p className='text-purple-contrast text-center font-semibold text-sm'>
                        Oportunidades globalmente
                    </p>
