...
export default function AboutUsSecondaryCard({
    ...
    const iconGradient: Record<typeof variant, string> = {
    ...
    return (
        <div className={`rounded-2xl border p-6 sm:p-8 lg:p-10 w-full md:w-[30%] flex flex-col items-center text-center gap-4 transition-all duration-500 transform hover:-translate-y-2 ${bgColor[variant]}`}>
