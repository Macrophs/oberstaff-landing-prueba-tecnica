...
export default function AboutUs() {
    return (
        <section id='about' className='flex flex-col items-center px-4 sm:px-6 lg:px-10 py-20 w-full bg-background min-h-[600px] gap-14'>
            <div className='flex flex-col items-center gap-6 sm:gap-10'>
                <div className='relative inline-block text-center'>
                    <h2 className='text-3xl sm:text-5xl lg:text-6xl font-semibold'>¿Qué Hacemos?</h2>
            ...
            <section className='flex flex-col md:flex-row w-full justify-center gap-6 md:gap-10'>
