        ...
        <section id="contact" className="flex flex-col items-center px-4 md:px-10 py-16 md:py-20 w-full bg-gradient-to-br from-blue-dark to-blue-dark/95 text-background min-h-[600px] gap-12 md:gap-14">
            ...
            <div className="w-full max-w-4xl">
                <MotionEffect
                    ...
                    delay={0.3}
                    className="bg-white/10 backdrop-blur-sm rounded-3xl p-6 md:p-12 border border-white/20 shadow-2xl"
                    inView>
                            ...
                            <div className="group">
                                ...
                                <div className="flex flex-col sm:flex-row gap-3">
                                    ...
                                    <PatternFormat
                                        ...
                                        className="w-full sm:w-24 px-4 py-4 bg-white/20 backdrop-blur-sm border border-white/30 rounded-2xl text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all duration-300 "
                                    />
                                    ...
                                    <div className="relative w-full">
                                        <PatternFormat
                                            ...
                                            className="w-full px-4 py-4 bg-white/20 backdrop-blur-sm border border-white/30 rounded-2xl text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all duration-300"
                                        />
                                    </div>
                                </div>
                            </div>
